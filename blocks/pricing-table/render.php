    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="grid gap-8 md:grid-cols-3 items-stretch">
            <?php foreach ($items as $item): ?>
                ...
                $class = $hasBadge ? 'relative border-2 border-[#5ce1ca] shadow-2xl scale-[1.02]' : 'border border-white/10 shadow-lg hover:shadow-2xl transition';
                ?>
                <div class="text-white rounded-2xl p-8 flex flex-col justify-between bg-[#2d1b33] <?php echo $class; ?>">
                    <?php if ($hasBadge): ?>
